...
function NewPostPage() {
  ...
  const [value, setValue] = useState(""); //for desc from react-quill
  const [error, setError] = useState("");
  const [images, setImages] = useState([]);

  //navigate if everything is correct
  ...
  const handleSubmit = async (e) => {
    ...
    //instead of getting data one by one we can do it alltogether
    ...
    try {
      const res = await apiRequest.post("/posts", {
        postData: {
          ...
          images: images, //from the state images
        },
        postDetail: {
          desc: value, //desc is from the useState value
